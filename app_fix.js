...
const PLANTS = {
  // 1 サンスベリア
  sanse: plant(
    "サンスベリア（ローレンティ）","永久 / 不滅","明るい室内〜半日陰（直射NG）",
